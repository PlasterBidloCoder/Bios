...
function BiosSetingsPage.Draw()
	...
	set(50,19,'←→    Выбрать экран')
	set(50,20,'↑↓    Выбрать Предмет')
	set(50,21,'Enter Выбрать меню')
	set(50,22,'F9    Выйти и сохранить')
...
local function HiMenu() -- меню приветствия
	...
	set(11,1,'BIOS')
	set(7,15,'F12 В настройки')
	set(8,16,'Любая кнопка пропустить')
